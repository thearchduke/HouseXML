...
<!-- The preceding is very important for me to understand how it works. I think I'm getting it.
    ...
    <xsl:template match="paragraph">
        <xsl:choose>
            ...
            <xsl:when test="ancestor::quoted-block">
                <span class="bodyParaQuoted"><a name="{@id}"></a>
                    <xsl:apply-templates></xsl:apply-templates>
                </span>
            </xsl:when>            
        </xsl:choose>
    ...
    <xsl:template match="section">
        <xsl:choose>
            ...
            <xsl:when test="ancestor::quoted-block">
                <span class="sectionQuoted"><a name="{@id}"></a>
                    <xsl:apply-templates></xsl:apply-templates>
                </span>
            </xsl:when>            
        </xsl:choose>   
    ...
    <xsl:template match="subsection">
        <xsl:choose>
            ...
            <xsl:when test="ancestor::quoted-block">
                <span class="subsectionQuoted"><a name="{@id}"></a>
                    <xsl:apply-templates></xsl:apply-templates>
                </span>
            </xsl:when>
        </xsl:choose>
    ...
    <xsl:template match="text[ancestor::quoted-block]">
